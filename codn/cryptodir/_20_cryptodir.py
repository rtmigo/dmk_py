...
from ._10_kdf import CodenameKey
from ._10_salt_files_old import find_salt_in_dir, write_salt_and_fakes
from .namegroup import NewNameGroup, decrypt_from_dios, update_namegroup_old
...
class CryptoDir:
    ...
    def set_from_io(self, name: str, source: BinaryIO):
        pk = CodenameKey(name, self.salt)
        update_namegroup_old(source, pk, self.directory)
