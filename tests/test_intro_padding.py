...
from ksf._51_encryption import _IntroPadding
...
class TestEncryptDecrypt(unittest.TestCase):
    ...
    def test_min_len_1(self):
        self.assertEqual(
            min(len(_IntroPadding.gen_bytes()) for _ in range(200)),
            1)

    def test_max_len_15(self):
        self.assertEqual(
            max(len(_IntroPadding.gen_bytes()) for _ in range(200)),
            15)
